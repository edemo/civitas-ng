...
public class VerifiableVote implements XMLSerializable {
	...
	/**
	 * Proof of knowledge of the voter's vote, including its capability, choice, and
	 * context.
	 */
	...
	public VerifiableVote(String context, ElGamal1OfLReencryption encChoice, ElGamalCiphertext encCapability,
			ProofVote proofVote) {
	...
	public boolean equals(VerifiableVote vv) {
		...
		return (this.context == vv.context || (this.context != null && this.context.equals(vv.context)))
				...
				&& (this.encCapability == vv.encCapability
						|| (this.encCapability != null && this.encCapability.equals(vv.encCapability)))
	...
	public boolean verify(ElGamalPublicKey pubKey, CiphertextList ciphertexts, int L) {
		if (proofVote == null || encChoice == null)
			return false;
		if (pubKey == null)
			return false;
	...
	public static VerifiableVote fromXML(Reader r) throws IllegalArgumentException, IOException {
