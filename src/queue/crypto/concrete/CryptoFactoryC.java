...
//      }
    ...
    public int[] createPermutation(Label   int size) {
    ...
    public VoteCapability[] combineVoteCapabilityShares(Label   VoteCapabilityShare[][] shares, ElGamalParameters p) {
    ...
    public ElGamalCiphertext[] multiplyCiphertexts(Label   ElGamalSignedCiphertext[][] ciphertexts, ElGamalParameters p) {
    ...
    public ElGamalPublicKey combineKeyShares(Label   ElGamalKeyShare[] shares) throws CryptoException {
        if (shares == null) return null;
    ...
    public ElGamal1OfLReencryption elGamal1OfLReencrypt(Label    
     ...
     */
    public ElGamalCiphertext[] constructWellKnownCiphertexts(Label   ElGamalPublicKey key, int count) {
    ...
    public ElGamalCiphertext elGamalCiphertextFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
    ...
    public ElGamalParameters elGamalParametersFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalParametersC.fromXML(  r);
    }

    public ElGamalPrivateKey elGamalPrivateKeyFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalPrivateKeyC.fromXML(  r);
    }

    public ElGamalProofKnowDiscLog elGamalProofKnowDiscLogFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalProofKnowDiscLogC.fromXML(  r);
    }

    public ElGamalPublicKey elGamalPublicKeyFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalPublicKeyC.fromXML(  r);
    }

    public ElGamalSignedCiphertext elGamalSignedCiphertextFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalSignedCiphertextC.fromXMLsub(  r);
    }

    public PETCommitment petCommitmentFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return PETCommitmentC.fromXML(  r);
    }

    public PETDecommitment petDecommitmentFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return PETDecommitmentC.fromXML(  r);
    }    

    public ElGamalProofDiscLogEquality elGamalProofDiscLogEqualityFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalProofDiscLogEqualityC.fromXML(  r);
    }

    public VoteCapability voteCapabilityFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return VoteCapabilityC.fromXML(  r);
    }

    public VoteCapabilityShare voteCapabilityShareFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return VoteCapabilityShareC.fromXML(  r);
    }

    public ElGamal1OfLReencryption elGamal1OfLReencryptionFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamal1OfLReencryptionC.fromXML(  r);
    }
    public ElGamalProof1OfL elGamalProof1OfLFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalProof1OfLC.fromXML(  r);
    }
    public PETShare petShareFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return PETShareC.fromXML(  r);
    }

    public ElGamalMsg combineDecryptionShares(Label   ElGamalCiphertext c, ElGamalDecryptionShare[] shares, ElGamalParameters params) throws CryptoException { 
    ...
    public ElGamalCiphertext combinePETShareDecommitments(Label   PETDecommitment[] decs, ElGamalParameters params) throws CryptoException {        
    ...
    public ElGamalDecryptionShare constructDecryptionShare(Label   Label lbl2, ElGamalCiphertext c, ElGamalKeyPairShare keyShare) {
    ...
    public ElGamalDecryptionShare decryptionShareFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalDecryptionShareC.fromXML(  r);
    }
    public ElGamalReencryptFactor elGamalReencryptFactorFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return ElGamalReencryptFactorC.fromXML(  r);
    }
    public PublicKeyCiphertext publicKeyCiphertextFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return PublicKeyCiphertextC.fromXML(  r);
    }

    public SharedKeyCiphertext sharedKeyCiphertextFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return SharedKeyCiphertextC.fromXML(  r);
    }

    public SharedKey sharedKeyFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return SharedKeyC.fromXML(  r);
    }

    public SharedKey sharedKeyFromWire(Label   Reader r) throws IllegalArgumentException, IOException {
    ...
    public ElGamalProofDVR elGamalProofDVRFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
    ...
    public ElGamalPrivateKey egPrivKeyFromFile(String keyFile) throws IllegalArgumentException, FileNotFoundException, IOException {
        ...
        return elGamalPrivateKeyFromXML(  new BufferedReader(new FileReader(keyFile)));
    }
    ...
    public ElGamalKeyShare elGamalKeyShareFromXML(Label   Reader r) throws IllegalArgumentException, IOException { 
    ...
    public Signature signature(PrivateKey k, Label   byte[] bytes) {
        try {
            numPublicKeySign++;
    ...
    public boolean publicKeyVerifySignature(PublicKey K, Signature s, Label   byte[] bytes) {
        return publicKeyVerifySignature(K, s, bytes);
    }
    ...
    public Signature signatureFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return SignatureC.fromXML(  r);
    }
    public PublicKey publicKeyFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        return PublicKeyC.fromXML(  r);
    }
    public PrivateKey privateKeyFromXML(Label   Reader r) throws IllegalArgumentException, IOException {
    ...
    public byte[] freshNonce(Label   int bitlength) {
    ...
    public byte[] messageDigest(Label   byte[] a) {
        MessageDigest md = messageDigest(lbl);
        md.update(a);
        return md.digest();
    }
    public byte[] messageDigest(Label   Label lbl2, byte[] a, boolean constArray) {
        return messageDigest(  a, constArray);
    }
    public byte[] messageDigest(Label   byte[] a, boolean constArray) {
        return messageDigest(  a);
    }

    public byte[] messageDigest(Label   byte[] a, int i) {
        MessageDigest md = messageDigest(lbl);
        md.update(a);
        md.update(i);
        return md.digest();
    }
    public byte[] messageDigest(Label   Label lbl2,  byte[] a, int i, boolean constArray) {
        return messageDigest(  a, i, constArray);
    }
    public byte[] messageDigest(Label   byte[] a, int i, boolean constArray) {
        return messageDigest(  a, i);
    }
    ...
    public String freshNonceBase64(Label   int bitlength) {
        return bytesToBase64(  freshNonce(  bitlength));
    }


    public String bytesToBase64(Label   byte[] a) {
        return Base64.encodeBytes(a);
    }
    public String constBytesToBase64(Label   byte[] a) {
        return Base64.encodeBytes(a);
    }
    ...
    public ProofVote proofVoteFromXML(Label   Reader r) 
