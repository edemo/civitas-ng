...
public class ElGamalPublicKeyC extends ElGamalAbstractKey implements ElGamalPublicKey {
    ...
    public void toXML(Label   PrintWriter s) {
        ...
        s.print("</params>");
        s.print("<y>");
        if (this.y != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.y),   s);
        s.print("</y>");
        
        s.print("</"); s.print(EG_OPENING_TAG); s.print('>');
    }
    
    public static ElGamalPublicKeyC fromXML(Label   Reader r) throws IllegalArgumentException, IOException {
