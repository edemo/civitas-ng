...
public class ElGamalProofDiscLogEqualityC implements ElGamalProofDiscLogEquality {
    ...
    public void toXML(Label   PrintWriter s) {
        ...
        s.print("<g1>");
        if (this.g1 != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.g1),   s);
        s.print("</g1>");
        s.print("<g2>");
        if (this.g2 != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.g2),   s);
        s.print("</g2>");
        s.print("<v>");
        if (this.v != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.v),   s);
        s.print("</v>");
        s.print("<w>");
        if (this.w != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.w),   s);
        s.print("</w>");
        s.print("<a>");
        if (this.a != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.a),   s);
        s.print("</a>");
        s.print("<b>");
        if (this.b != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.b),   s);
        s.print("</b>");
        s.print("<c>");
        if (this.c != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.c),   s);
        s.print("</c>");
        s.print("<r>");
    ...
    public static ElGamalProofDiscLogEquality fromXML(Label   Reader r) throws IllegalArgumentException, IOException {
