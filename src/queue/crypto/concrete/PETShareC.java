...
class PETShareC implements PETShare {
    ...
    public void toXML(Label   PrintWriter sb) {
        if (sb == null) return;
        sb.append("<petShare>");
    ...
    public static PETShareC fromXML(Label   Reader r) throws IOException {
        ...
        CivitasBigInteger exponent = CryptoFactoryC.stringToBigInt(Util.unescapeString(Util.readSimpleTag(  r, "exponent")));
