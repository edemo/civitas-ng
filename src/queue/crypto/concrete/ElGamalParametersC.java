...
class ElGamalParametersC implements ElGamalParameters {
	...
	public void toXML(Label   PrintWriter s) {
		...
		s.print("<p>");
		if (this.p != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.p),   s);
		s.print("</p>");
		s.print("<q>");
		if (this.q != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.q),   s);
		s.print("</q>");
		s.print("<g>");
		if (this.g != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.g),   s);
		s.print("</g>");

		s.print("</elGamalParameters>");
	}

	public static ElGamalParametersC fromXML(Label   Reader r) throws IllegalArgumentException, IOException {
