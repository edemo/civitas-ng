...
public class ElGamalSignedCiphertextC extends ElGamalCiphertextC implements ElGamalSignedCiphertext {
    ...
    public void toXML(Label   PrintWriter s) {
        ...
        s.print("<a>");
        if (a != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.a),   s);
        s.print("</a>");
        s.print("<b>");
        if (b != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.b),   s);
        s.print("</b>");
        s.print("<c>");
        if (c != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.c),   s);
        s.print("</c>");
        s.print("<d>");
        if (d != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.d),   s);
        s.print("</d>");
        s.print("</elGamalSignedCiphertext>");
    }
    
    public static ElGamalSignedCiphertext fromXMLsub(Label   Reader r) throws IllegalArgumentException, IOException {
    ...
    public void toUnsignedCiphertextXML(Label   PrintWriter sb) {
        super.toXML(  sb);
    }     
