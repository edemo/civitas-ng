...
public class PETCommitmentC implements PETCommitment {
    ...
    public void toXML(Label   PrintWriter s) {
        ...
        if (hash != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.hash),   s);

        s.print("</"); s.print(OPENING_TAG); s.print('>');
    }

    public static PETCommitmentC fromXML(Label   Reader r) throws IllegalArgumentException, IOException {
