...
public class PETDecommitmentC implements PETDecommitment {
    ...
    public void toXML(Label   PrintWriter s) {
        ...
        s.print("<d>");
        if (di != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.di),   s);
        s.print("</d>");
        s.print("<e>");
        if (ei != null) Util.escapeString(CryptoFactoryC.bigIntToString(this.ei),   s);
        s.print("</e>");
        s.print("<prf>");
        proof.toXML(  s);
        s.print("</prf>");
    ...
    public static PETDecommitmentC fromXML(Label   Reader r) throws IllegalArgumentException, IOException {
