...
public class ElGamalDecryptionShareC implements ElGamalDecryptionShare {
    ...
    public void toXML(Label   PrintWriter s) {
        ...
        s.print('>');
        s.print("<ai>");
        if (ai != null) Util.escapeString(CryptoFactoryC.bigIntToString(ai),   s);
        s.print("</ai>");
    ...
    public static ElGamalDecryptionShareC fromXML(Label   Reader r) throws IllegalArgumentException, IOException {
        ...
        ElGamalProofDiscLogEqualityC proof = (ElGamalProofDiscLogEqualityC)CryptoFactoryC.singleton().elGamalProofDiscLogEqualityFromXML(  r);
