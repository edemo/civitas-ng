...
public class ElGamalCiphertextC implements ElGamalCiphertext {
    ...
    public static ElGamalCiphertextC fromXML(Label   Reader r) throws IllegalArgumentException, IOException {
    ...
    public void toUnsignedCiphertextXML(Label   PrintWriter s) {
        toXML(  s);
    }
