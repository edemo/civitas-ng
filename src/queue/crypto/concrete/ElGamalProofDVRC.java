...
//        }
    ...
    public static ElGamalProofDVR fromXML(Label   Reader reader) throws IllegalArgumentException, IOException {
        Util.swallowTag(  reader, "elGamalProofDVR");
        ElGamalCiphertextC e = (ElGamalCiphertextC)CryptoFactoryC.singleton().elGamalCiphertextFromXML(  reader);
        ElGamalCiphertextC eprime = (ElGamalCiphertextC)CryptoFactoryC.singleton().elGamalCiphertextFromXML(  reader);
        CivitasBigInteger c = CryptoFactoryC.stringToBigInt(Util.unescapeString(Util.readSimpleTag(  reader, "c")));
        CivitasBigInteger w = CryptoFactoryC.stringToBigInt(Util.unescapeString(Util.readSimpleTag(  reader, "w")));
        CivitasBigInteger r = CryptoFactoryC.stringToBigInt(Util.unescapeString(Util.readSimpleTag(  reader, "r")));
        CivitasBigInteger u = CryptoFactoryC.stringToBigInt(Util.unescapeString(Util.readSimpleTag(  reader, "u")));
