...
public class ElGamalKeyPairShare {
    ...
    public static ElGamalKeyPairShare fromXML (  Reader   r) throws (IllegalArgumentException , IOException ) {
        try {
            Util.swallowTag(  r, "elGamalKeyPairShare");
            ElGamalPublicKey pubKey = CryptoUtil.factory().elGamalPublicKeyFromXML(  r);
            ElGamalPrivateKey privKey = CryptoUtil.factory().elGamalPrivateKeyFromXML(  r);
