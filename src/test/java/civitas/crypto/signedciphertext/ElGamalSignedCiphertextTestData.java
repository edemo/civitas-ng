...
public interface ElGamalSignedCiphertextTestData
	...
	CivitasBigInteger EL_GAMAL_SIGNED_CIPHERTEXT_HASH1 = BIGINT_G
			.modPow(RANDOMS_0, BIGINT_P);
	CivitasBigInteger EL_GAMAL_SIGNED_CIPHERTEXT_A = BIGINT_G.modPow(FACTOR_E,
			BIGINT_P);
	...
	CivitasBigInteger G_POW_RANDOMS0_G_EXP_FACTOR_MESSAGE_MUL_PUBKEY_POW_FACTOR_ADDITIONALENV = BIGINT_G
			.modPow(RANDOMS_0_PLUS_HASH_MUL_FACTOR.mod(BIGINT_Q), BIGINT_P)
			.modMultiply(CIPHERTEXT_E_A.modPow(
					HASH_OF_G_POW_RANDOMS0_G_EXP_FACTOR_MESSAGE_MUL_PUBKEY_POW_FACTOR_ADDITIONALENV
							.modNegate(BIGINT_Q),
					BIGINT_P), BIGINT_P);
