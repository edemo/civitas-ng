...
public interface ProofKnowDiscLogTestData extends ElGamalPublicKeyCTestData {
	...
	ElGamalProofKnowDiscLogC EL_GAMAL_PROOF_KNOWN_DISC_LOG = new ElGamalProofKnowDiscLogC(
	...
	ElGamalProofKnowDiscLogC EL_GAMAL_PROOF_KNOWN_DISC_LOG_BAD = new ElGamalProofKnowDiscLogC(
