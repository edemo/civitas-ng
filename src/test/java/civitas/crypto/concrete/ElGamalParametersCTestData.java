...
public interface ElGamalParametersCTestData extends BasicValuesTestData {
	...
	public static final CivitasBigInteger P2 = TestUtil.asBigint(P2_BASE64);
	public static final CivitasBigInteger Q2 = TestUtil.asBigint(Q2_BASE64);
	public static final CivitasBigInteger G2 = TestUtil.asBigint(G2_BASE64);

	public static final CivitasBigInteger BIGINT_P_OTHER = TestUtil
			.asBigint(P_OTHER_BASE64);
	public static final CivitasBigInteger BIGINT_G_OTHER = TestUtil
	...
	public static final CivitasBigInteger GENERATOR_OTHER = TestUtil
			.asBigint(GENERATOR_OTHER_BASE64);

	public static final CivitasBigInteger GENERATOR_FOR_UNPRIME_P = TestUtil
			.asBigint("APPuKv0SXyLaZklKlEiPMfeSkEfsEfdN24AXL3NrYBKG");
	public static final CivitasBigInteger GENERATOR_FOR_UNPRIME_Q = TestUtil
