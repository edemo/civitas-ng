...
public abstract class BallotDesign implements XMLSerializable {
	 ...
	 * <code>VoteCapability</code>s; an IllegalArgumentException is thrown if
	 * there
	 ...
	 * not the case.
	 */
	public final void checkVoterSubmission(VoterSubmission vs, String baseContext,
			CiphertextList ciphertexts, ElGamalPublicKey pubKey)
	 ...
	 */
	public abstract void checkVoterSubmission(VoterSubmission vs, int startIndex,
			String context, CiphertextList ciphertexts, ElGamalPublicKey pubKey)
			throws IllegalArgumentException;

	/**
	 * The number of votes in a <code>VoteSubmission</code> that will be produced
	 * by
