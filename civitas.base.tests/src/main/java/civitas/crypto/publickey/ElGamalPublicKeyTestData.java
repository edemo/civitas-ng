...
public interface ElGamalPublicKeyTestData extends ElGamalPrivateKeyTestData {
	...
	ElGamalPublicKey EL_GAMAL_PUBLIC_KEY_EPRIME = new ElGamalPublicKey(
			PUBKEY_EPRIME, EL_GAMAL_PARAMETERS);
	ElGamalPublicKey EL_GAMAL_PUBLIC_KEY_E = new ElGamalPublicKey(
			PUBKEY_E, EL_GAMAL_PARAMETERS);
	ElGamalPublicKey EL_GAMAL_PUBLIC_KEY_E_BUT_OTHER_PARAMETERS = new ElGamalPublicKey(
			PUBKEY_E, EL_GAMAL_PARAMETERS_OTHER);
	ElGamalPublicKey EL_GAMAL_PUBLIC_KEY_A_USING_G_OTHER = new ElGamalPublicKey(
	...
	String EL_GAMAL_PUBLIC_KEY_NULL_XML = "<elGamalPublicKey>"
			+ "<params></params><y></y></elGamalPublicKey>";
	String EL_GAMALPUBLIC_KEY_NAME = "ElGamalPublicKey-"
			+ G_EXP_A_BASE64;
