...
import civitas.common.votersubmission.CheckVoterSubmission;

class CheckVoterSubmissionTest extends RandomAwareTestBase implements VoterSubmissionTestData {
	...
	@DisplayName(
			...
			""")
	void test() {
		assertDoesNotThrow(() -> checkVoterSubmission.apply(
				BALLOTDESIGN, VOTER_SUBMISSION, ADDITIONALENV, CIPHERTEXT_LIST, EL_GAMAL_PUBLIC_KEY_E));
	}
	...
	void test1() {
		assertThrows(
				...
				() -> checkVoterSubmission.apply(BALLOTDESIGN, VOTER_SUBMISSION, ADDITIONALENV, CIPHERTEXT_LIST, null));
	}
	...
	void test1_1() {
		assertThrows(
				IllegalArgumentException.class,
				() -> checkVoterSubmission.apply(
						BALLOTDESIGN, VOTER_SUBMISSION, null, CIPHERTEXT_LIST, EL_GAMAL_PUBLIC_KEY_E));
	}
	...
	void test2() {
		...
		assertThrows(
				IllegalArgumentException.class,
				() -> checkVoterSubmission.apply(
						BALLOTDESIGN, null, ADDITIONALENV, CIPHERTEXT_LIST, EL_GAMAL_PUBLIC_KEY_E));
	}
	...
	void test4() {
		...
		assertThrows(
				...
				() -> checkVoterSubmission.apply(
						BALLOTDESIGN,
						VOTER_SUBMISSION_WITH_BAD_CONTEXT,
						ADDITIONALENV,
						CIPHERTEXT_LIST,
						EL_GAMAL_PUBLIC_KEY_E));
	}
	...
	void test5() {
		...
		assertThrows(
				...
				() -> checkVoterSubmission.apply(
						BALLOTDESIGN,
						VOTER_SUBMISSION_WITH_BAD_PROOF,
						ADDITIONALENV,
						CIPHERTEXT_LIST,
						EL_GAMAL_PUBLIC_KEY_E));
	}
