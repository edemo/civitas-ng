package civitas.common.mix.capabilityelementrevelation.tests;
...
class VerifyMixCapabilityElementRevelationTest extends RandomAwareTestBase implements CapabilityMixTestData {
	...
	@Test
	@DisplayName("if the relevation is RandomAwareTestBasenull, a NullPointerException is thrown")
	void test1() {
		assertThrows(
	...
	void test3() {
		assertThrows(
				NullPointerException.class,
				() -> verifyMixCapabilityElementRevelation.apply(
						CAPABILITY_ELEMENT_RELEVATION, EL_GAMAL_PUBLIC_KEY_EPRIME, 0, 1, null, CAPABILITY_MIX_REMIXED));
	}
