...
import civitas.common.mix.votemix.GetReencryptedVoteFromMix;
import civitas.common.tests.RandomAwareTestBase;

class GetReencryptedVoteFromMixTest extends RandomAwareTestBase implements VoteMixTestData {
	...
	void test() {
		assertEquals(
				TO_VOTE,
				getReencryptedVoteFromMix.apply(
						FROM_MIX,
						0,
	...
	void test1() {
		assertThrows(
				...
				() -> getReencryptedVoteFromMix.apply(
						null, 0, ELGAMAL_REENCRYPT_FACTOR_E, ELGAMAL_REENCRYPT_FACTOR_EPRIME, EL_GAMAL_PUBLIC_KEY_E));
	}
	...
	void test2() {
		assertThrows(
				NullPointerException.class,
				() -> getReencryptedVoteFromMix.apply(
						FROM_MIX, 0, null, ELGAMAL_REENCRYPT_FACTOR_EPRIME, EL_GAMAL_PUBLIC_KEY_E));
	}
	...
	void test3() {
		assertThrows(
				NullPointerException.class,
				() -> getReencryptedVoteFromMix.apply(
						FROM_MIX, 0, ELGAMAL_REENCRYPT_FACTOR_E, null, EL_GAMAL_PUBLIC_KEY_E));
	}
	...
	void test4() {
		assertThrows(
				NullPointerException.class,
				() -> getReencryptedVoteFromMix.apply(
						FROM_MIX, 0, ELGAMAL_REENCRYPT_FACTOR_E, ELGAMAL_REENCRYPT_FACTOR_EPRIME, null));
	}
