...
class CloseBoardControllerTest extends TestBase
	...
	void test2() throws InvalidKeySpecException, IOException,
			NoSuchAlgorithmException, CommunicableException {
		closeBoardController.apply(BULLETIN_BOARD_ID, ELECTION_ID, NUM_VOTER_BLOCKS,
	...
	void test3() throws InvalidKeySpecException, IOException {
		assertThrows(NullPointerException.class,
				() -> closeBoardController.apply(BULLETIN_BOARD_ID, null,
						NUM_VOTER_BLOCKS, SIGNATURE_OF_AUTH_NONCE_WITH_KEY));
	}
	...
	void test4() throws InvalidKeySpecException, IOException {
		assertThrows(NullPointerException.class, () -> closeBoardController
	...
	void test5() throws InvalidKeySpecException, IOException {
		assertThrows(IllegalArgumentException.class,
				() -> closeBoardController.apply(BULLETIN_BOARD_ID, ELECTION_ID, -1,
						SIGNATURE_OF_AUTH_NONCE_WITH_KEY));
	}
