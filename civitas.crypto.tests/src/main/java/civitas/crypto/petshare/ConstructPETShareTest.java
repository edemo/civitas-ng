...
class ConstructPETShareTest extends RandomAwareTestBase implements PETShareTestData {
	...
	void test() {
		PETShare actual = constructPETShare.apply(EL_GAMAL_PARAMETERS, CIPHERTEXT_E, CIPHERTEXT_EPRIME);
