...
class CombineKeySharesTest extends TestBase implements ElGamalKeyShareTestData {
	...
	void test_1() throws CryptoException {
		...
		verify(combineKeyShares.verifyElGamalKeyShare).apply(EL_GAMAL_KEY_SHARE_EPRIME);
	}
	...
	void test2() throws CryptoException {
		assertThrows(
				...
				() -> combineKeyShares.apply(new ElGamalKeyShare[] {EL_GAMAL_KEY_SHARE_NOT_GOOD_PUBKEY_TYPE}));
	}
