...
public interface PrivateKeyTestData {
	...
	java.security.PrivateKey PRIVATE_KEY_BAD = mock(
	...
	PKCS8EncodedKeySpec KEYSPEC_PRIVATE2 = new PKCS8EncodedKeySpec(
			Base64.getDecoder().decode(PRIVATE_KEY2_BASE64));
	String PRIVATE_KEY_XML = "<PrivateKey><keyBase64>"
