...
public interface ElgamalMsgTestData extends ElGamalParametersTestData {
	...
	CivitasBigInteger MESSAGE_VOTE_CAPABILITY_SHARE = CivitasBigIntegerFactory.obtain(VOTE.getBytes());

	CivitasBigInteger MESSAGE_VOTE_CAPABILITY_SHARE_ENCODED = BIGINT_G.modPow(MESSAGE_VOTE_CAPABILITY_SHARE, BIGINT_P);
	ElGamalMsg EL_GAMAL_MESSAGE_VOTE_CAPABILITY_SHARE = new ElGamalMsg(MESSAGE_VOTE_CAPABILITY_SHARE_ENCODED);
}
