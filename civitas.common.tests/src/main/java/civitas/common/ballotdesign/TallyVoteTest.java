...
class TallyVoteTest extends RandomAwareTestBase implements TallyStateTestData,
	...
	void test() {
		...
		tallyVote.apply(ADDITIONALENV, new ElGamalMsg(I_BEATS_J_ENCODED), CONTEXT_0,
				tallyState, DECODEMAP);
	...
	void test_1() {
		TallyState tallyState = TALLY_STATE_EMPTY_SUPPLIER.get();
		tallyVote.apply(ADDITIONALENV, new ElGamalMsg(J_BEATS_I_ENCODED), CONTEXT_0,
				tallyState, DECODEMAP);
	...
	void test1() {
		assertThrows(IllegalArgumentException.class,
				() -> tallyVote.apply(ADDITIONALENV, new ElGamalMsg(I_BEATS_J_ENCODED),
						null, TALLY_STATE_EMPTY_SUPPLIER.get(), DECODEMAP));
	}
	...
	void test1_2() {
		assertThrows(IllegalArgumentException.class,
				() -> tallyVote.apply(ADDITIONALENV, new ElGamalMsg(BIGINT_A),
						CONTEXT_0, TALLY_STATE_EMPTY_SUPPLIER.get(), DECODEMAP));
	}
	...
	void test2() {
		assertThrows(IllegalArgumentException.class,
				() -> tallyVote.apply(ADDITIONALENV, new ElGamalMsg(I_BEATS_J_ENCODED),
						BARE_CONTEXT_0, TALLY_STATE_EMPTY_SUPPLIER.get(), DECODEMAP));
	}
	...
	void test2_1() {
		assertThrows(IllegalArgumentException.class,
				() -> tallyVote.apply(ADDITIONALENV, new ElGamalMsg(I_BEATS_J_ENCODED),
						CONTEXT_BAD, TALLY_STATE_EMPTY_SUPPLIER.get(), DECODEMAP));
	}
	...
	void test2_2() {
		assertThrows(IllegalArgumentException.class,
				() -> tallyVote.apply(ADDITIONALENV, new ElGamalMsg(I_BEATS_J_ENCODED),
						CONTEXT_BAD_NOINT, TALLY_STATE_EMPTY_SUPPLIER.get(), DECODEMAP));
	}
	...
	void test3() {
		assertThrows(IllegalArgumentException.class,
				() -> tallyVote.apply(ADDITIONALENV, null, CONTEXT_0,
						TALLY_STATE_EMPTY_SUPPLIER.get(), DECODEMAP));
	}
